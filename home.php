...
<html lang="en">
  <head>
    ...
    <title>Selamat datang di Expulsa</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h1 style="color: #a7402fff">EXPULSA</h1>
            <h2>Solusi Terbaik untuk Jasa Penukaran Pulsa. EXPULSA sangat terpercaya dan cepat mendengar layanan pelanggan.</h2>
            <div class="d-lg-flex">
              <a href="#contact" class="btn-get-started scrollto">JADILAH PELANGGAN TERBAIK KAMI !</a>
              <!-- <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Watch Video <i class="icofont-play-alt-2"></i></a> -->
            </div>
          </div>
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
            <!-- <img src="assets/img/hero-img.png" class="img-fluid animated" alt="" /> -->
            <img src="hp.png" class="img-fluid animated" alt="" />
          </div>
        </div>
      </div>
    </section>
    ...
    <main id="main">
      ...
      <section id="cliens" class="cliens">
        <div class="container">
          <div class="row" data-aos="zoom-in">
            <div class="col-lg-4 col-md-4 col-6 d-flex align-items-center justify-content-center" style="border: black">
              <img src="assets/img/clients/cs.png" class="img-fluid" alt="" />
            </div>

            <div class="col-lg-4 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="assets/img/clients/rate.png" class="img-fluid" alt="" />
            </div>

            <div class="col-lg-4 col-md-4 col-6 d-flex align-items-center justify-content-center">
              <img src="assets/img/clients/money.png" class="img-fluid" alt="" />
            </div>
            <!-- 
      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row content">
            <div class="col-lg-6">
              <h1>Apa itu EXPULSA ?</h1>
              <p style="color: black">
                EXPULSA merupakan salah satu jasa penukaran pulsa dengan rate yang baik. Di mana penukaran pulsa merupakan cara menukarkan pulsa menjadi uang/saldo rekening/saldo fintech/saldo ecommerce dll. Jumlah uang yang diterima
                berdasarkan nilai tukar yang telah ditentukan/disepakati bersama yang disebut dengan istilah rate
              </p>
              <!-- <div class="slider" style = " width: 300px;
              height: 300px;
              display: flex;
              overflow-x: auto;">
                <div class="slide" id="slide-1" style = "width: 300px;
                flex-shrink: 0;
                height: 100%;">1</div>
                <div class="slide" id="slide-2" style = "width: 300px;
                flex-shrink: 0;
                height: 100%;">2</div>
                <div class="slide" id="slide-3" style = "width: 300px;
                flex-shrink: 0;
                height: 100%;">3</div>
                <div class="slide" id="slide-4" style = "width: 300px;
                flex-shrink: 0;
                height: 100%;">4</div>
                <div class="slide" id="slide-5 " style = "width: 300px;
                flex-shrink: 0;
                height: 100%;">5</div>
              </div> -->
            </div>
            ...
            <div class="col-lg-6 pt-4 pt-lg-0">
              ...
              <center>
                <img src="conversion.png" alt="" style="width: 300px; text-align: center" />
              </center>
            </div>
          </div>
        </div>
      ...
      <section id="services" class="services">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            ...
            <p>Berikut merupakan pilihan Rate pulsa yang kami tawarkan.</p>
          </div>
            ...
            <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box" style="text-align: center">
                <div class="icon" style="text-align: center">
                  ...
                  <img src="xldua.png" alt="" style="width: 75%; text-align: center" />
                </div>
                <h4><a>XL</a></h4>
                <strong>
                  <p>30.000 – 2.999.000 : <a style="color: blue; font-size: 15px"> 0,73</a></p>
                </strong>
                <strong>
                  <p>3.000.000 – Unlimited : <a style="color: blue; font-size: 15px"> 0,75</a></p>
                </strong>
                <a href="#contact" class="btn btn-success" style="margin-top: 15px; border-radius: 10px">Langganan </a>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
              <div class="icon-box" style="text-align: center">
                <div class="icon">
                  ...
                  <img src="threedua.png" alt="" style="width: 75%; text-align: center" />
                </div>
                <h4><a>THREE</a></h4>
                <strong>
                  <p>30.000 – 3.000.000 : <a style="color: blue; font-size: 15px"> 0,80</a></p></strong
                >
                <strong>
                  <p>3.001.000 – Unlimited : <a style="color: blue; font-size: 15px"> 0,82</a></p>
                </strong>
                <a href="#contact" class="btn btn-success" style="margin-top: 15px; border-radius: 10px">Langganan </a>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
              <div class="icon-box" style="text-align: center">
                <div class="icon">
                  ...
                  <img src="axisdua.png" alt="" style="width: 75%; text-align: center" />
                </div>
                <h4><a>AXIS</a></h4>
                <strong>
                  <p>100.000 – 2.500.000 : <a style="color: blue; font-size: 15px"> 0,75</a></p>
                </strong>
                <strong>
                  <p>2.501.000 – Unlimited : <a style="color: blue; font-size: 15px"> 0,76</a></p>
                </strong>
                <a href="#contact" class="btn btn-success" style="margin-top: 15px; border-radius: 10px">Langganan </a>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
              <div class="icon-box" style="text-align: center">
                <div class="icon">
                  ...
                  <img src="telkomseldua.png" alt="" style="width: 75%; text-align: center" />
                </div>
                <h4><a>TELKOMSEL</a></h4>
                <strong>
                  <p>100.000 – 2.500.000 : <a style="color: blue; font-size: 15px"> 0,75</a></p>
                ...
                <!-- <a href = "" class = "btn btn-success" style = "margin-top:15px; border-radius:10px; ">Langganan </a> -->
                <a href="#contact" class="btn btn-success" style="margin-top: 15px; border-radius: 10px">Langganan </a>
              </div>
            </div>
          </div>
        ...
        <div class="container" data-aos="zoom-in">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              <h3>Ingin Gratis Konsultasi mengenai Pelayanan Kami ?</h3>
              <p>Kami Bersedia membuka diri untuk berkonsultasi dengan anda secara GRATIS !!</p>
            </div>
            <div class="col-lg-3 cta-btn-container text-center">
             <strong><a class="cta-btn align-middle" href="http://api.whatsapp.com/send?phone=6287847972064">Ingin Konsultasi</a></strong> 
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="team" class="team">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>Testimonial</h2>
            <p>Berikut merupakan Testimoni dari Pelanggan Kami !</p>
          </div>
      ...
      <section id="contact" class="contact">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2>Tukar Pulsa Sekarang YUK !</h2>
            <p>
              Pengen Tukar Pulsa sekarang aja ? Yuk kami siap melayani anda !
            </p>
          </div>
          ...
          <!-- <div class="row">
            ...
            <!-- <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch"> -->
              <div class="col-lg-12 mt-4 mt-lg-0 d-flex align-items-stretch">
              <!-- <form action="send.php" method="post" role="form" class="php-email-form" target = "_blank"> -->
              <form action="send.php" method="post" class="php-email-form">
                <div class="form-row">
                  <div class="form-group col-md-12">
                    <!-- <label for="name">Nominal Pulsa</label> -->
                    <label for="name">Tolong Masukkan Nominalnya dengan benar</label>
                    <input type="text" name="nominal_pulsa" class="form-control" id="nominal_pulsa" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required />
                ...
                <div class="form-group">
                  <label for="name">Pilih Provider</label>
                  <select name="provider" class = "form-control" id="provider" aria-placeholder="Silakan Pilih Provider Anda" required>
                    <option disabled selected value>--Silakan Pilih Provider Anda--</option>
                ...
                <div class="form-group">
                  <label for="name">Nomor Pengirim Pulsa</label>
                  <input type="number" class="form-control" name="nomor_pengirim" id="nomor_pengirim" data-rule="minlen:9" data-msg="Silakan Masukkan Nomornya dengan benar" required />
                  <div class="validate"></div>
                </div>

                <div class="form-group">
                  <label for="name">Bank / Dompet Digital</label>
                  <input type="text" class="form-control" name="bank_dompet" id="bank_dompet" data-rule="minlen:1" data-msg="Tolong Masukkan Dompet Digital / Bank Anda" required />
                  <div class="validate"></div>
                </div>

                <div class="form-group">
                  <label for="name">Nomor rekening</label>
                  <input type="number" class="form-control" name="nomor_rekening" id="nomor_rekening" data-rule="minlen:9" data-msg="Silakan Masukkan Nomornya dengan benar" required />
                  <div class="validate"></div>
                </div>
...
<!-- 
                ...
                <div class="text-center"><button type="submit" name = "submit" id = "submit">Kirim ke Whatsapp Admin</button></div>
              </form>
            </div>
          </div>
        </div>
