  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
    ...
    <main id="main" style = "margin-top:100px;">
      ...
      <section id="about" class="about">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row content">
            ...
            <option value="0.73">XL</option>
            <option value="0.75">XL ( sampai Unlimited )</option>
            <option value="0.75">AXIS</option>
            <option value="0.76">AXIS ( sampai Unlimited )</option>
            <option value="0.75">Telkomsel</option>
            <option value="0.76">Telomsel ( sampai Unlimited )</option>
            <option value="0.80">Three</option>
            <option value="0.82">Three ( sampai Unlimited )</option>
            </select>
            </div> -->
      ...
      <div class="modal fade" id="modalingat" tabindex="-1" role="dialog" aria-labelledby="modalingatTitle" aria-hidden="true">
